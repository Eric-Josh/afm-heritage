                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item nav-list">
                                <a href="/tracts"  class="nav-link">Tracts</a>
                            </li>
                            <li class="nav-item nav-list">
                                <a href="/bstudies"  class="nav-link">Bible Study</a>
                            </li>
                            <li class="nav-item nav-list">
                                <a href="/cgs"  class="nav-link">Collected Gospel Songs</a>
                            </li>
                            <li class="nav-item nav-list">
                                <a href="/sunsch"  class="nav-link">Sunday School</a>
                            </li>
                            <li class="nav-item nav-list">
                                <a href="/std"  class="nav-link">Steps To Deliverance</a>
                            </li>
